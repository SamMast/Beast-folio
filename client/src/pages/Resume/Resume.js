...
const Resume = () => (
  <div style={{clear:"both"}} id="resume">
    <div className="pageHeader">
  	...
  	<br />
  	<br />
  	<div style={{position:"fixed",top:"15%",minWidth:"100%"}}>
  		<img src="https://sammast.github.io/Responsive-Portfolio/assets/images/IMG_3302.jpg" alt="sam" style={{display:"block",margin:"auto",borderRadius:"50%",height:"25vh",width:"25vh",boxShadow:"0 2px 5px 0 rgba(0,0,0,.16), 0 2px 10px 0 rgba(0,0,0,.12)"}} />
  	</div>
